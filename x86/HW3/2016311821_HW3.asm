...
; print strings
	...
	mov edi, 80*2*6+0
	mov bl, 0x02
	call printf_s ; to LDT2_Start
	
	call LDT2_Call_Gate:LDT2_Next
...
LDT2_Call_Gate equ 14h
	dw LDT2_Next; offset 15:00
	dw LDT2_CODE_SEL_0; seg selector
	db 0x00 ; 000, param count
	db 0x8c ; p,dpl,0,1100
	dw 0x0000; offset 31:164	
LDT2_CODE_SEL_1 equ 0x1c
	dw 0x00ff ; limit 15:00
	dw 0x0000 ; address 15:00
	db 0x00; address 23:16
	db 0x9a; p,dpl,s,type
